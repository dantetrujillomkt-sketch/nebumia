...
function buildSaldoAnteriorRows(allCajaRows, tab, rangeStart, rangeEnd) {
  ...
  // Desde el mes de hoy en adelante: el saldo de un mes es literalmente el Balance Neto (misma
  // fórmula que la tarjeta, vía accountBalanceNetoForMonth) del mes anterior — arrastre simple,
  // no una re-derivación de todo el historial. Los meses antes de hoy no se tocan.
